...
rem offset after a nested batch call and silently skips whole sections, so this would
rem launch something other than what it says. Refuse to start from one.
